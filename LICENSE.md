...
هذا المشروع متاح بموجب ترخيص مخصص للاستخدام التعليمي وغير التجاري. يُرجى قراءة الشروط التالية بعناية:
This project is licensed under a custom educational and non-commercial license. Please read the following terms carefully:

### 1. الاستخدام المسموح (Permitted Use)
- يُسمح بنسخ وتعديل وتطوير وإعادة توزيع هذا المشروع **للأغراض التعليمية والشخصية وغير التجارية فقط**.
- You are free to copy, modify, develop, and redistribute this project for **educational, personal, and non-commercial purposes only**.

### 2. الاستخدام التجاري (Commercial Use)
- **يُمنع منعاً باتاً** استخدام هذا المشروع، أو أي جزء منه، لأي غرض تجاري، بما في ذلك بيع التطبيق أو تحقيق أرباح من خلاله، إلا بعد الحصول على إذن خطي مسبق.
- **Strictly Prohibited:** You may not use this project, or any part of it, for any commercial purpose, including selling the application or monetizing it, without prior written permission.
...
- This project is provided "as is" without warranty of any kind, express or implied. The developers and supervisors are not liable for any claim, damages, or other liability arising from, out of, or in connection with the software or the use or other dealings in the software.

---

للتواصل بخصوص الأذونات التجارية أو الاستفسارات، يرجى المراسلة على:
For commercial permissions or inquiries, please contact:
**azayed@atlahub.tech**
